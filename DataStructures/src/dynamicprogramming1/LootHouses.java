...
public class LootHouses {
	...
	public static void main(String[] args) {
        ...
        int[] houses = { 5,5,10,100,10,5}; // Change this to test with different values
        int maxLooted = maxMoneyLooted(houses);
        
        System.out.println("Maximum amount of money that can be looted: " + maxLooted);
